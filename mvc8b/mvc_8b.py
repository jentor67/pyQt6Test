...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.title_btn.setStyleSheet("background-color : yellow")
        ...
        self.NameLabel.setText("Hello John")
        self.NameLabel.setAlignment(Qt.AlignmentFlag.AlignTop | \
                Qt.AlignmentFlag.AlignRight)
        layout.addRow("My Message",self.NameLabel)
    ...
    def update_ui(self):
        ...
        # disable_details is True/False, 
        # setting setDisabled to True disables the field.
